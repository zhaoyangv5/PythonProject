...
openresty进程存在#ps -ef | grep nginx | grep master | wc -l#=2#
...
磁盘空间#netstat -na | grep 8006 | grep LISTEN|grep -v grep | wc -l#=1#
磁盘空间#netstat -na | grep 10007 | grep LISTEN|grep -v grep | wc -l#=1#
